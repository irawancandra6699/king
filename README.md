...
### INSTALL SCRIPT 
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://arisctunnel.xyz/Lt.sh && chmod +x Lt.sh && ./Lt.sh
</code></pre>

### PERINTAH UPDATE 
<pre><code>wget https://arisctunnel.xyz/files/update && chmod +x update && ./update</code></pre>
